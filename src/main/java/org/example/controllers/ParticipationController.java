...
public class ParticipationController implements Initializable {
    ...
    private void handleCreateTeam() {
        ...
        try {
            Team newTeam = new Team(name, currentTournament.getId(), user.getId());
            teamService.ajouter(newTeam);
            teamService.ajouterJoueur(newTeam.getId(), user.getId());
    ...
    private void handleJoinTeam(Team team) {
        ...
        try {
            ...
            teamService.ajouterJoueur(team.getId(), user.getId());
    ...
    private void navigateToConfirmation(Team team) {
        ...
        try {
            MainFX.navigateTo("ConfirmationView.fxml", "✅  Confirmation — " + team.getName());
        } catch (Exception e) {
